              ...
              <div className="shadow-sm border-2 mt-6 p-4 rounded-md w-9/12 hover:shadow-xl">
                ...
                <div className="p-6  ">
                  <div className="flex justify-center ">
                    ...
                    <h1 className="ml-2">Sachin Dubey</h1>
                  </div>
                  <div className="flex justify-center mt-2">
                    <img src={email} className="h-4 w-4 mt-1" alt="email"></img>
                    <h4 className="ml-2">only2sachd@gmail.com</h4>
                  </div>
                  <div className="flex justify-center gap-10 mt-6 ">
                    <a href="https://www.instagram.com/sachindubey770/">
                      <img
                        src={admin_insta}
                        className="h-5 w-5"
                        alt="insta"
                    ...
                    <a href="https://github.com/onlysachd">
                      <img src={admin_git} className="h-5 w-5" alt="git"></img>
                    </a>
                    <a href="https://www.linkedin.com/in/sachin-dubey-6151aa20b/">
                      <img
                        src={admin_linkedin}
                        className="h-5 w-5 "
                        alt="linkedin"
